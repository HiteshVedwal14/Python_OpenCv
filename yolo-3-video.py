...
video = cv2.VideoCapture('D:\Python\Yolo\own dataset\myvideo\myvideo.mp4')
...
with open('D:/Python/Yolo/YOLO-3-OpenCV/yolo-coco-data/coco.names') as f:
...
network = cv2.dnn.readNetFromDarknet('D:/Python/Yolo/YOLO-3-OpenCV/yolo-coco-data/yolov3.cfg',
                                      'D:/Python/Yolo/YOLO-3-OpenCV/yolo-coco-data/yolov3.weights')
...
while True:
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter('D:\Python\Yolo\own dataset\myvideo\result-myvideo.mp4', fourcc, 30,
